// Ícones inline exclusivos das telas de auth/onboarding (login não compartilha
// o icons.tsx do shell). SVGs mínimos; cor herda via currentColor salvo o
// Google (multicolor por marca).
...
export function AppleIcon({ size = 16 }: IconProps) {
  return (
...
export function SparklesIcon({ size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      <path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9L12 3zM19 17l.7 1.8L21.5 19.5l-1.8.7L19 22l-.7-1.8L16.5 19.5l1.8-.7L19 17z" />
    </svg>
  );
}
