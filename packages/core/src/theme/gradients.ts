/**
 * Gradientes do protótipo. Tipo próprio (sem dependência de expo) para ser
 * consumível por mobile (expo-linear-gradient) e web. Os campos colors/start/end
 * são estruturalmente compatíveis com LinearGradientProps do expo.
 */
