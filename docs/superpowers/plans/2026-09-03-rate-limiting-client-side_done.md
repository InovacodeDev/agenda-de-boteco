...
- [x] **Step 2: Instanciar o cooldown e envolver os handlers**
...
- [x] **Step 3: Trocar os `onClick` pelos guardados**
...
- [x] **Step 4: Adicionar o botão de reenvio com contagem e o aviso de limite**
...
- [x] **Step 5: Resetar o cooldown ao trocar de e-mail**
...
- [x] **Step 6: Verificar typecheck e lint**
...
- [x] **Step 2: Instanciar o cooldown e guardar os handlers**
...
- [x] **Step 2: Instanciar o cooldown**
...
- [x] **Step 3: Guardar o "Esqueci minha senha" e o OAuth**
...
- [x] **Step 4: Adicionar reenvio no passo de código**
...
- [x] **Step 1: Guardar o favoritar do EventCard**
...
- [x] **Step 2: Guardar o favoritar da página de estabelecimento**
...
- [x] **Step 3: Verificar typecheck e lint**
