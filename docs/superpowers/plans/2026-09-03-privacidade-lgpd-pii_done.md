...
- [x] **Step 2: Substituir a Seção 2 inteira**
...
- [x] **Step 3: Acrescentar o PostHog à Seção 4**
...
- [x] **Step 4: Verificar typecheck e lint**
...
- [x] **Step 4: Atualizar o docblock do topo**
...
- [x] **Step 5: Verificar typecheck e testes**
...
- [x] **Step 2: Adicionar o redirect de `/privacidade`**
...
- [x] **Step 1: Adicionar o import do Link**
...
- [x] **Step 2: Substituir o parágrafo final pelo texto com link**
...
- [x] **Step 1: Criar a página fora do route group `(painel)`**
...
- [x] **Step 2: Linkar a política na tela de login**
