...
- [x] **Step 2: Criar o log de máquina**
...
- [x] **Step 3: Verificar que o JSON é válido**
...
- [x] **Step 2: Tornar o hook executável**

Run: `chmod +x .githooks/pre-commit`
Expected: sem saída.

- [x] **Step 3: Criar o script de ativação**
...
- [x] **Step 2: Validar a lógica localmente**
...
- [x] **Step 3: Validar a sintaxe YAML**
...
- [x] **Step 1: Atualizar a tabela de versões da Seção 6**
...
- [x] **Step 3: Adicionar o item 18 ao Checklist**
...
- [x] **Step 4: Adicionar a regra de paginação à Seção 3**
...
- [x] **Step 5: Verificar que o arquivo continua bem formado**
...
- [x] **Step 1: Apontar a regra de paginação no AGENTS.md**
...
- [x] **Step 2: Apontar a auditoria periódica no AGENTS.md**
...
- [x] **Step 3: Documentar a ativação do hook no README de dev**
...
- [x] **Step 2: Confirmar que o hook está ativo e passa**
...
- [x] **Step 3: Confirmar que a data registrada está dentro do prazo**
...
- [x] **Step 4: Registrar o passo manual pendente**
...
- [x] **Step 5: Nenhum CHANGELOG necessário**
