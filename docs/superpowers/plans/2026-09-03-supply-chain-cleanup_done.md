...
- [x] **Step 1: Registrar o estado atual da auditoria**
...
- [x] **Step 2: Adicionar os overrides**
...
- [x] **Step 4: Verificar a suíte completa**
...
- [x] **Step 1: Rodar a auditoria de novo**
...
- [x] **Step 2: Registrar `image-size` como risco aceito**
...
- [x] **Step 1: Verificar se o override de react ainda é necessário**
...
- [x] **Step 2: Decidir sobre react/react-dom**
...
- [x] **Step 3: Alinhar o override de lightningcss**
...
- [x] **Step 1: Reconfirmar que ninguém importa as fachadas**
...
- [x] **Step 2: Confirmar que `utils/auth.ts` é a fachada, não o service**
...
- [x] **Step 3: Deletar as fachadas órfãs**
...
- [x] **Step 4: Verificar typecheck e testes do mobile**
...
- [x] **Step 5: Remover a menção a `mapStyle.ts` do README do mobile**
...
- [x] **Step 6: Remover `eslint-config-expo`**
...
- [x] **Step 1: Confirmar a versão instalada**
...
- [x] **Step 2: Ler a documentação oficial do upgrade**
...
- [x] **Step 4: Avaliar os demais majors disponíveis**
